...
export const en = {
  ...
  settings: {
    ...
    priceSourceHint: 'Yahoo needs no key but its endpoint is unofficial and throttles without warning \u2014 that is why prices sometimes stop updating.',
    priceSourceYahoo: 'Yahoo (no key)',
    priceSourceFinnhub: 'Finnhub (personal key)',
    finnhubKeyHint: 'A free Finnhub key gives you 60 requests a minute under an actual contract. It is stored on this device only and sent to Finnhub alone.',
    finnhubUsOnly: 'The free plan covers US stocks. Tel Aviv listings keep coming from Yahoo automatically.',
    backup: 'Backup',
