...
export const he: Dictionary = {
  ...
  settings: {
    ...
    priceSource: 'מקור המחירים',
    priceSourceHint: 'Yahoo לא דורש מפתח, אבל נקודת הקצה שלו לא רשמית והיא חוסמת בקצב בלי הודעה — זו הסיבה שמחירים לפעמים מפסיקים להתעדכן.',
    priceSourceYahoo: 'Yahoo (בלי מפתח)',
    priceSourceFinnhub: 'Finnhub (מפתח אישי)',
    finnhubKeyHint: 'מפתח Finnhub חינמי נותן 60 קריאות בדקה עם חוזה אמיתי מאחוריו. הוא נשמר על המכשיר הזה בלבד ונשלח רק ל-Finnhub.',
    finnhubUsOnly: 'התוכנית החינמית מכסה מניות אמריקאיות. מניות תל אביב ימשיכו להימשך מ-Yahoo אוטומטית.',
    backup: 'גיבוי',
